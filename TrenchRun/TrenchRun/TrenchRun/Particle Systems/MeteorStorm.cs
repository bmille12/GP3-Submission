...
namespace DPSF.ParticleSystems
{
	...
	[Serializable]
#endif
    class MeteorStorm : DefaultQuadParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public MeteorStorm(Game cGame) : base(cGame) { }
        ...
        public void LoadParticleSystem()
        {
            ...
            InitialProperties.LifetimeMax = 0.15f;
            InitialProperties.PositionMin = new Vector3(0,0,-2);
            InitialProperties.PositionMax = new Vector3(0,0,-2);
            InitialProperties.VelocityMin = new Vector3(-2, -1, -2);
            InitialProperties.VelocityMax = new Vector3(0, 1, 0);
            ...
            InitialProperties.StartWidthMin = 0.15f;
            InitialProperties.StartWidthMax = 0.6f;
            InitialProperties.StartHeightMin = 0.15f;
            InitialProperties.StartHeightMax = 0.6f;
            InitialProperties.EndWidthMin = 0.45f;
            InitialProperties.EndWidthMax = 1.8f;
            InitialProperties.EndHeightMin = 0.45f;
            InitialProperties.EndHeightMax = 1.8f;
            InitialProperties.StartColorMin = Color.DarkSalmon;
            InitialProperties.StartColorMax = Color.DarkSalmon;
            InitialProperties.EndColorMin = Color.SandyBrown;
            InitialProperties.EndColorMax = Color.SandyBrown;
            ...
            Emitter.PositionData.Position = new Vector3(0, 0.0f, 20);
        }
        ...
        {
            Emitter.PositionData.Position += new Vector3(a, 0, 0);
        }

        public void setPosition(Vector3 a)
        {
            Emitter.LerpEmittersPositionAndOrientationOnNextUpdate = false;
            Emitter.PositionData.Position = a;
        }

        public void update()
        {
            if (Emitter.PositionData.Position.Z > 10)
            {
                this.Visible = false;
            }
        }

...
namespace DPSF.ParticleSystems
{
	...
	[Serializable]
#endif
    class EngineFire : DefaultQuadParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public EngineFire(Game cGame) : base(cGame) { }
        ...
        public void LoadParticleSystem()
        {
            ...
            InitialProperties.PositionMin = new Vector3(-0.5f,-0.1f,0);
            InitialProperties.PositionMax = new Vector3(0.5f,0.1f,0);
            InitialProperties.VelocityMin = new Vector3(-1, 0, 1);
            InitialProperties.VelocityMax = new Vector3(1, 0, 5);
            ...
            InitialProperties.StartWidthMin = 0.05f;
            InitialProperties.StartWidthMax = 0.2f;
            InitialProperties.StartHeightMin = 0.05f;
            InitialProperties.StartHeightMax = 0.2f;
            InitialProperties.EndWidthMin = 0.15f;
            InitialProperties.EndWidthMax = 0.15f;
            InitialProperties.EndHeightMin = 0.15f;
            InitialProperties.EndHeightMax = 0.315f;
            ...
            Emitter.PositionData.Position = new Vector3(0, 0f, 2);
        }
